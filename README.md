...
- Dễ dàng đọc, hiểu, trình bày khỏi mất công bản thân "tự chế" kiểu code không giống ai.
 - Vì vậy với 1 quy chuẩn chung trong dự án, nó sẽ giúp:
 	+ Cải thiện khả năng đọc/review code.
 	+ Việc bảo trì, phát triển code dễ dàng hơn.
	+ Và Quốc có Quốc pháp, Code có Code quy!
#### PSR là gì?
...
- PSR bao gồm 20 chuẩn, nhưng ở đây mình chỉ nói 3 chuẩn là PSR-1, PSR-2, PSR-3(Đây là 3 chuẩn bất kỳ người nào review code PHP cần phải nắm rõ).
...
## 3. Các chuẩn cơ bản cần tuân thủ khi review PHP(PSR):
### 3.1. PSR-1: Basic Coding Standard
#### 3.1.1. Overview
...
#### 3.1.4. Class Constants, Properties, and Methods
...
### 3.3. PSR-3: Logger Interface
#### 3.3.1. Concept Logger
